    ...
    useEffect(() => {
        if(!document.cookie.match(/^(.*;)?\s*cookie-consent\s*=\s*[^;]+(.*)?$/)) {
            ...
            <div className="cookie-banner-container">
                <p className="consent-message">Wir benutzen Cookies, die ausschließlich der Funktionalität dieser Seite dienen.</p>
                <button className="consent-button" onClick={setConsentCookie}>Nicht mehr anzeigen</button>
            </div> )
        }
        else {
