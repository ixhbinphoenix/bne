...
use crate::{models::{model::ConnectionData, user_model::User, links_model::{Link, LinkType}}, mail::{utils::{Mailer, load_template}, mailing::{build_mail, send_mail}}};
...
pub async fn forgot_password_post(body: web::Json<ForgotPassword>, db: ConnectionData, mailer: web::Data<Mailer>) -> Result<impl Responder> {
